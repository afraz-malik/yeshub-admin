...
import sectionApi from "../../api/stage-section";
                    ...
                    <Col md="12">
                        <Card>
                            <CardHeader className="d-flex justify-content-between align-items-center">
                                ...
                                <Link className="btn btn-primary" to={`/admin/stages/sections/create-update/${pid}`}>
                                    Add Section
                                </Link>
                            </CardHeader>
                            <CardBody>
                                                  ...
                                                  <tr key={section._id}>
                                                      ...
                                                      <td className="text-right">
                                                          <Link
                                                              ...
                                                              to={{
                                                                  pathname: `/admin/stages/sections/create-update/${pid}`,
                                                                  state: { section },
                                                              }}
                                                          >
                                                              Edit
